...
describe Reward do
  ...
  it "should have a display_minimum" do
    ...
    r.minimum_value = 10
    r.display_minimum.should == "US$ 10,00"
    r.minimum_value = 99
    r.display_minimum.should == "US$ 99,00"
  end
  ...
  it "should have a HTML-safe name that is a HTML composition from minimum_value, description and sold_out" do
    ...
    r.minimum_value = 10
    r.name.should == "<div class='reward_minimum_value'>US$ 10,00+</div><div class='reward_description'>Description</div><div class='clear'></div>"
    r.description = "Description<javascript>XSS()</javascript>"
    r.name.should == "<div class='reward_minimum_value'>US$ 10,00+</div><div class='reward_description'>Description&lt;javascript&gt;XSS()&lt;/javascript&gt;</div><div class='clear'></div>"
  end
end
