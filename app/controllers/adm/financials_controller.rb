        ...
        csv_string = CSV.generate do |csv|
          ...
          projects.each do |project|
            ...
            csv << [project.name,
                    ...
                    "#{view_context.number_to_currency project.backers.confirmed.sum('payment_service_fee'), unit: 'US$', precision: 2, delimiter: '.'}",
                    "#{view_context.number_to_currency catarse_fee, unit: 'US$', precision: 0, delimiter: '.' } (#{view_context.number_to_currency project.pledged - catarse_fee, unit: 'US$', precision: 0, delimiter: '.'})",
